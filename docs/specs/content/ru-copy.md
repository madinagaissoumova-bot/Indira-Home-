# Russian Client Copy - Indira Home

Ce fichier sert de base de textes russes pour l'interface cliente.

Les textes admin peuvent aussi etre en russe, mais cette liste priorise les textes visibles par les clientes.

## Navigation et marque

| Usage | Texte russe |
| --- | --- |
| Nom boutique | Indira Home |
| Accueil catalogue | Каталог |
| Categories | Категории |
| Panier | Корзина |
| Retour catalogue | Вернуться в каталог |
| Continuer achats | Продолжить покупки |
| WhatsApp boutique | WhatsApp магазина: +7 988 906-41-06 |
...
| Rechercher | Найти |
| Effacer recherche | Очистить |
| Filtres | Фильтры |
| Reinitialiser filtres | Сбросить |
| En stock uniquement | Только в наличии |
| Nouveautes | Новинки |
| Tri defaut | По умолчанию |
| Prix croissant | Сначала дешевле |
| Prix decroissant | Сначала дороже |
| Nouveautes d'abord | Сначала новинки |
| Voir produit | Смотреть |
| Ajouter panier | В корзину |
| Nouveau | Новинка |
...
| Usage | Texte russe |
| --- | --- |
| Retour catalogue | Назад в каталог |
| Ajouter panier | Добавить в корзину |
...
| Usage | Texte russe |
| --- | --- |
| Titre panier | Корзина |
| Panier vide | Ваша корзина пуста. |
| Produit retire | Товар удален из корзины. |
| Vider panier | Очистить корзину |
| Retirer | Удалить |
| Total | Итого |
| Somme commande | Сумма заказа |
...
- Textes courts.
- Pas d'explications longues cote cliente.
- Ne jamais afficher les enums techniques.
- Ne jamais afficher la quantite exacte en stock.
- Ne jamais afficher de paiement en ligne.
- Toujours rappeler la confirmation par telephone ou WhatsApp au checkout et a la confirmation.
