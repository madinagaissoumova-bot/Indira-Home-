...
| Statut | Description |
| --- | --- |
| Nouvelle | Commande recue, pas encore traitee |
| A confirmer | La boutique doit contacter la cliente |
| Confirmee | La cliente a confirme la commande |
| En preparation | La boutique prepare la commande |
| Livree | La commande a ete remise a la cliente |
| Annulee | La commande ne sera pas traitee |

Le statut initial apres validation est "Nouvelle".
...
- Une commande validee arrive d'abord avec le statut "Nouvelle".
