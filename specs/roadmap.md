...
Le detail d'execution reste dans `specs/work-plan.md`. Les regles fonctionnelles restent dans les fiches de `specs/feature-specs/`.
...
- La checklist `specs/test-plan.md` est passee.
